...
`# Create a new user  adduser craft # Add the user to the sudo group usermod -aG sudo craft # Install Docker curl -fsSL https://get.docker.com | bash # Add the user to the Docker group usermod -aG docker craft # Switch to the new user su - craft`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzc5MjM4NjQyLDEwMTE4NjE3NjQsMTI4MD
E2OTE4OCwtMTE3NTA0ODQxOF19
-->