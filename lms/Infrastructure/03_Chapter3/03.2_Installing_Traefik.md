...
```bash
 ...
 ```
## 2\. **Create a DockerileCreate a** D`**docker network for Traefik to communicate with your containers:-compose.yml**` **network for Traefik to communicate with your containers:
```bash
 docker network create web
 ```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTc1MTg3NjEsNjUxNTAzNjg5LDExOT
cwMTY0NDNdfQ==
-->