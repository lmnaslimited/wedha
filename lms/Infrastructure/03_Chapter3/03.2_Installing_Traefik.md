...
```bash
 ...
 ```
## 2\. Create a ockerileCreate a** ocker-compose.yml**` **network for Traefik to communicate with your containers:` file to define Traefik and a sample web application. In this example, Traefik will route traffic to a simple web app.
```bash
 docker network create web
 ```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NDU2NTEzNTUsLTIxMTc1MTg3NjEsNj
UxNTAzNjg5LDExOTcwMTY0NDNdfQ==
-->