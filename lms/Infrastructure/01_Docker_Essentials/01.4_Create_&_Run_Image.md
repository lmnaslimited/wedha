...
### **Create a Dockerfile**:
Inside the project directory, create a file named `Dockerfile` with the following content. You can use VS Code or any text editor like `vi` or `nano`:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTE0NzM2MzAwLDE4MDQ2NzI0NjIsNTcwNz
E4MDUyLDE4NzE0NjA5NjcsMjg0ODM2ODg1LDE4Njg0MzgxMDcs
LTcyNzQyMDY0NiwxMjQ3NzcxNzg2LC0yMDg4NzQ2NjEyLDczMD
k5ODExNl19
-->