...
### **Create a Dockerfile**:
Inside the project directory, create a file named `Dockerfile` with the following content by using VS Code or vi or nano text editors :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTcwNzE4MDUyLDE4NzE0NjA5NjcsMjg0OD
M2ODg1LDE4Njg0MzgxMDcsLTcyNzQyMDY0NiwxMjQ3NzcxNzg2
