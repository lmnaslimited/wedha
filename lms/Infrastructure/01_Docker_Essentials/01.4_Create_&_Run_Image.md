...
### **Create a Dockerfile**:
Inside the project directory, create a file named `Dockerfile` with the following content by using VS Code or any text editors like :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NDQyNzQ3NzksMTg3MTQ2MDk2NywyOD
Q4MzY4ODUsMTg2ODQzODEwNywtNzI3NDIwNjQ2LDEyNDc3NzE3
ODYsLTIwODg3NDY2MTIsNzMwOTk4MTE2XX0=
-->