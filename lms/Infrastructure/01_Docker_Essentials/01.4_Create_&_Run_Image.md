...
### **Create a Dockerfile**:
Inside the project directory, create a file named `Dockerfile` with the following content by using VS Code or any text editors like  vi and nano:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDc3MjcwMTgsMTgwNDY3MjQ2Miw1Nz
A3MTgwNTIsMTg3MTQ2MDk2NywyODQ4MzY4ODUsMTg2ODQzODEw
NywtNzI3NDIwNjQ2LDEyNDc3NzE3ODYsLTIwODg3NDY2MTIsNz
MwOTk4MTE2XX0=
-->