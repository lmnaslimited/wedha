...
### **Create a Dockerfile**:
Inside the project directory, create a file named `Dockerfile` with the following content by using VS Code or vi or nanoy text editors like :
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgwNDY3MjQ2Miw1NzA3MTgwNTIsMTg3MT
Q2MDk2NywyODQ4MzY4ODUsMTg2ODQzODEwNywtNzI3NDIwNjQ2
LDEyNDc3NzE3ODYsLTIwODg3NDY2MTIsNzMwOTk4MTE2XX0=
-->