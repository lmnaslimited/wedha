...
If the file in any other directory specify the path to the directory containing the Dockerfile. For example, if your Dockerfile is in a directory named `dockerfiles`:
```bash
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MzY0ODU5ODYsLTE4ODY3ODA4NTAsLT
U1NDQyMzA5OCw2MDg4MTUzMTUsMTAyMjIyNDU0NF19
-->