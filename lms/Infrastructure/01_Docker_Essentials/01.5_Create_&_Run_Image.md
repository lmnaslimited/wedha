...
### **Create a Dockerfile**:
Inside the project directory, create a file named `Dockerfile` with the following content. You can use VS Code or  text editors like ` vi` or `nano`:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyMjIyNDU0NF19
-->