...
**Objective:** Learn how to build a custom Docker image using a `dockerfile` and additional configuration files.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDcxNzc4MDg1LDE2MTE5Njk3NzgsLTE5OD
