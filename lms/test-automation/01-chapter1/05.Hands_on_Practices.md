...
Your test files (specs) will go inside the `cypress/e2e` folder (Cypress 10 and above) or `cypress/integration` (Cypress 9 and below).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzOTQ1NjYwNSwtMTUzNzA2Mjc3NCwtNj
k0MDY5MTkxLC0yMTE0NzQ5NjY3XX0=
-->