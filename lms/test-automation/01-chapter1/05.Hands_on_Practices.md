...
2.  Open **test1.cy.js** in your code editor and add the following code:
	...
	it('passes', () => {
	cy.visit('https://nectar.lmnas.com/app/attendance');
  ...
  This script visits a demolens and login to the page.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI4NjgyNzQ0OCw2ODkwMTY4MiwxMTIzNj
k2NjIwLDE1MDYxNTE2NjUsOTcyMDU5NzU0LDEwNTk0MzMzMiwt
MTUzNzA2Mjc3NCwtNjk0MDY5MTkxLC0yMTE0NzQ5NjY3XX0=
-->