...
2.  Open **test1.cy.js** in your code editor and add the following code:
    ...
    cy.get('#login_password').type('supportConfig@03')
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcyMTgzNDU1MSwxMTIzNjk2NjIwLDE1MD
YxNTE2NjUsOTcyMDU5NzU0LDEwNTk0MzMzMiwtMTUzNzA2Mjc3
NCwtNjk0MDY5MTkxLC0yMTE0NzQ5NjY3XX0=
-->