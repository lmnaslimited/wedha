...
-   **Bar Chart**: Monthly Sales Revenue by Region
-   **Line Chart**: Number of Orders Over the Last 6 Months
-   **Pie Chart**: Sales Contribution by Product Category
-   **List**: Top 5 Customers by Sales in the Last Month

### 2: Inventory Management Dashboard

-   **Line Chart**: Stock Levels Over Time
-   **Bar Chart**: Inventory Turnover by Product Category
-   **Pie Chart**: Stock Value Distribution by Warehouse
-   **List**: Items at or Below Reorder Level
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgyMDUyMDUwOCwxNDY0NjE2MjU5LDgyMD
I0OTI5M119
-->