...
4. Click on Add row in the fields table to enter the **Label** and **Type**.
5. Then Go to add the customized field to that corresponding DocType.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA1MjQzNDUxMyw2MTQ4MzgwNDUsMTkxOT
cyNDg1LC0xNTA4MTMzNjQ0XX0=
-->